...
public class InteractiveLineGraphView extends View {
    ...
    private static final float AXIS_X_MIN = 0f;//-1f;
    private static final float AXIS_X_MAX = 16000f;//1f;
    private static final float AXIS_Y_MIN = 0f;//-1f;
    private static final float AXIS_Y_MAX = 2f;//1f;
