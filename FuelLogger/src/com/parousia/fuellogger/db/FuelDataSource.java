...
public class FuelDataSource {
	...
	private String[] allColumns = { AppConstants.COLUMN_ID,
			AppConstants.COLUMN_DATE,
			AppConstants.COLUMN_FUELAMOUNT,
			AppConstants.COLUMN_FUELPRICE,
			AppConstants.COLUMN_ODOMETER };
	...
	public FuelEntry createEntry(String dateTime, long odo, double fuelamount,
			double fuelprice) {
		ContentValues values = new ContentValues();
		values.put(AppConstants.COLUMN_DATE, dateTime);
		...
		long insertId = database.insert(AppConstants.TABLE_FUELLOG,
				null, values);
		Cursor cursor = database.query(AppConstants.TABLE_FUELLOG,
				allColumns, AppConstants.COLUMN_ID + " = " + insertId,
				null, null, null, null);
		cursor.moveToFirst();
	...
	public void deleteComment(FuelEntry entry) {
		...
		database.delete(AppConstants.TABLE_FUELLOG,
				AppConstants.COLUMN_ID + " = " + id, null);
	}
	...
	{
		Cursor c = database.rawQuery("SELECT " + AppConstants.COLUMN_DATE +" FROM " + AppConstants.TABLE_FUELLOG + " ORDER BY "+ AppConstants.COLUMN_DATE+" DESC", null);
		String lastDate="";
